...
export async function addProductController(req, res,next) {
    ...
    //   console.log("***** Linea 73 products.controller.js ******");
    //   console.log("addProductsController -- req.body -->", productToAdd);
    //   console.log("addProductsController -- req.user._id -->", ownerId);
    //   console.log("***** Linea 76 products.controller.js ******");
      productToAdd.owner = ownerId
    //   console.log("***** Linea 78 products.controller.js ******");
